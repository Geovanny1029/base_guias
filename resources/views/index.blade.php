...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="/" class="logo">Control <span class="lite">de guias</span></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="{{route('agente.index')}}">Agentes</a></li>             
              <li><a class="" href="{{route('Aerolinea.index')}}">Aerolineas</a></li>              
            </ul>
          </li>
